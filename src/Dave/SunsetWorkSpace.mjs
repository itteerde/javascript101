...
//new Date(game.time.components.year, game.time.components.month - 1, game.time.components.day, game.time.components.hours, game.time.components.minutes, game.time.components.seconds)